...
import { Sun, Moon, ChevronDown, X, Menu, Zap, ArrowRight, Github, Terminal, EyeOff, Eye, Undo2, Redo2, Bold, Italic, Strikethrough, Code2, List, ListOrdered, Quote, SquareCode, Link2, Unlink2, ImagePlus, Eraser } from "lucide-react";
    ...
    "header",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "border-t border-border/60 py-1 px-4 text-center text-[10px] uppercase font-semibold tracking-wider text-muted-foreground flex justify-center items-center gap-1.5 bg-background/50", children: [
          /* @__PURE__ */ jsx(Zap, { className: "w-2.5 h-2.5 text-primary-light" }),
...
function OlonHeroView({ data }) {
  return /* @__PURE__ */ jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-6xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-3 items-center", children: [
            ...
            /* @__PURE__ */ jsx(Button, { asChild: true, variant: "outline", size: "lg", className: "font-semibold gap-2", children: /* @__PURE__ */ jsxs("a", { href: data.cta.secondary.href, children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden md:flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-lg", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute inset-[-8%] bg-[radial-gradient(circle_at_50%_50%,rgba(52,109,255,0.22),rgba(12,17,22,0)_70%)] blur-2xl" }),
          /* @__PURE__ */ jsxs("div", { className: "relative aspect-[1/1.03] overflow-hidden rounded-none border border-white/14 bg-[#0d1219] shadow-[0_22px_56px_rgba(4,8,20,0.42)]", children: [
            /* @__PURE__ */ jsx(
              "img",
              {
                src: heroPlugImage,
            ...
            /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[linear-gradient(180deg,rgba(7,11,21,0.02)_0%,rgba(7,11,21,0.14)_24%,rgba(7,11,21,0.44)_100%)]" }),
            /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_62%_44%,rgba(122,163,255,0.18),rgba(29,78,216,0.08)_24%,rgba(12,17,22,0)_54%)] mix-blend-screen" })
          ] })
        ] }) })
      ] })
    }
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-8", children: [
        ...
        /* @__PURE__ */ jsx(
          "h2",
          {
            className: "text-4xl font-bold tracking-[-0.03em] text-foreground leading-tight",
            "data-jp-field": "headline",
            children: data.headline
          }
        ),
            ...
            children: data.pillars.map((pillar) => /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "font-bold text-foreground", "data-jp-field": "title", children: pillar.title }),
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-8", children: [
        ...
        /* @__PURE__ */ jsx(
          "h2",
          {
            className: "text-4xl font-bold tracking-[-0.03em] text-foreground mb-3",
            "data-jp-field": "headline",
            children: data.headline
          }
        ),
            ...
            children: data.protocols.map((p) => /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-foreground text-base", "data-jp-field": "name", children: p.name }),
                  /* @__PURE__ */ jsx(
                    "p",
                    {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 border-b border-[var(--local-border)] flex items-center gap-3", children: [
                /* @__PURE__ */ jsx("span", { className: "w-6 h-6 rounded-full bg-[var(--local-p400)] text-foreground text-xs font-bold flex items-center justify-center flex-shrink-0", children: step.number }),
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground text-sm", children: step.title }),
                /* @__PURE__ */ jsx("span", { className: "ml-auto text-xs text-[var(--local-muted)]", children: step.meta })
              ] }),
              /* @__PURE__ */ jsx("pre", { className: "p-6 font-mono text-xs leading-relaxed bg-[#080E14] text-gray-300 overflow-x-auto whitespace-pre-wrap min-h-[200px]", children: step.code })
            ]
          },
          step.number
        )) }),
            ...
            children: data.cards.map((card) => /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-foreground text-base", "data-jp-field": "title", children: card.title }),
                  /* @__PURE__ */ jsx(
                    "p",
                    {
                      className: "text-sm text-[var(--local-muted)] leading-relaxed flex-1",
